...
export default function PrivacyPage() {
  return (
    <main id="contenido" className="privacy-page">
      ...
      <aside className="privacy-review-note"><strong>Información pendiente de validación antes de publicar.</strong><p>Falta confirmar la identidad y domicilio del responsable legal, el canal formal para ejercer derechos y las condiciones de los proveedores de producción. Esta página describe la implementación actual; no reemplaza esa revisión.</p></aside>
      ...
      <section><h2>Servicios y enlaces externos</h2><p>Las imágenes, tipografías y código de esta versión se sirven desde el sitio. El catálogo puede consultar EverShop desde el servidor cuando esté configurado. Las solicitudes técnicas necesarias para servir una página no dependen de la medición opcional.</p><p>WhatsApp, Instagram y el correo se abren sólo cuando usás sus enlaces. Al salir del sitio se aplican las condiciones del servicio elegido. Cuando se habilite un pago, su proveedor también tendrá sus propias condiciones. La configuración final de alojamiento, registros, transferencias y conservación debe confirmarse antes de producción.</p></section>
